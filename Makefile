...
ARCH		?= arm64
CROSS_COMPILE	?= /home/dave/crdroid/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-androidkernel-
...
CC		= /home/dave/crdroid/prebuilts/clang/host/linux-x86/clang-r383902/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE	?= /home/dave/crdroid/prebuilts/aarch64-linux-gnu-
